...
namespace RobotEurobot2Roues
{
    class RobotEurobot2Roues
    {
        ...
        static void Main(string[] args)
        {
            ...
            positioning2Wheels.OnCalculatedLocationEvent += localWorldMapManager.OnPhysicalPositionReceived;                 //Envoi du positionnement calculé au local wolrd map manager
